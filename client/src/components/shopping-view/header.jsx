...
function MenuItems() {
  ...
  // Removed unused searchParams and setSearchParams
  ...
  return (
    <div className="flex lg:items-center lg:flex-row flex-col gap-4">
      <DropdownMenu>
        ...
        <DropdownMenuContent
          side="bottom"
          className="w-96 p-4 bg-white border border-gray-300 rounded shadow-md"
        >
          <UserCartWrapper
            cartItems={
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent side="right" className="w-56 bg-white">
          ...
          <DropdownMenuItem onClick={() => navigate("/shop/account")}>
            <UserCog className="mr-2 h-4 w-4 bg-white" />
            Account
          </DropdownMenuItem>
          <DropdownMenuSeparator />
